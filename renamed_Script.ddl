...
ALTER TABLE con_task ADD CONSTRAINT con_task_pk PRIMARY KEY ( task_id );

CREATE TABLE dec_choice (
    dc_id               NUMBER NOT NULL,
    item                VARCHAR2(250),
    description         VARCHAR2(1000),
    price               NUMBER(12, 2),
    dec_session_ds_id   NUMBER NOT NULL,
    option_option_id    NUMBER NOT NULL
);

ALTER TABLE dec_choice ADD CONSTRAINT dec_choice_pk PRIMARY KEY ( dc_id );

CREATE TABLE dec_session (
...
ALTER TABLE dec_session ADD CONSTRAINT dec_session_pk PRIMARY KEY ( ds_id );
...
ALTER TABLE opt_price ADD CONSTRAINT opt_price_pk PRIMARY KEY ( osp_id );
...
CREATE TABLE stage_lookup (
    ...
    stage_description        VARCHAR2(1000),
    dec_session_ds_id        NUMBER NOT NULL,
    opt_price_osp_id         NUMBER NOT NULL,
    con_task_task_id         NUMBER NOT NULL,
    housetask_housetask_id   NUMBER NOT NULL
);

ALTER TABLE stage_lookup ADD CONSTRAINT stage_lookup_pk PRIMARY KEY ( stage_id );
...
ALTER TABLE con_task
    ADD CONSTRAINT con_task_housetask_fk FOREIGN KEY ( housetask_housetask_id )
        REFERENCES housetask ( housetask_id );

ALTER TABLE dec_choice
    ADD CONSTRAINT dec_choice_dec_session_fk FOREIGN KEY ( dec_session_ds_id )
        REFERENCES dec_session ( ds_id );

ALTER TABLE dec_choice
    ADD CONSTRAINT dec_choice_option_fk FOREIGN KEY ( option_option_id )
        REFERENCES "Option" ( option_id );

ALTER TABLE dec_session
...
ALTER TABLE opt_price
    ADD CONSTRAINT opt_price_option_fk FOREIGN KEY ( option_option_id )
        REFERENCES "Option" ( option_id );
...
ALTER TABLE stage_lookup
    ADD CONSTRAINT stage_lookup_con_task_fk FOREIGN KEY ( con_task_task_id )
        REFERENCES con_task ( task_id );

ALTER TABLE stage_lookup
    ADD CONSTRAINT stage_lookup_dec_session_fk FOREIGN KEY ( dec_session_ds_id )
        REFERENCES dec_session ( ds_id );

ALTER TABLE stage_lookup
    ADD CONSTRAINT stage_lookup_housetask_fk FOREIGN KEY ( housetask_housetask_id )
        REFERENCES housetask ( housetask_id );

ALTER TABLE stage_lookup
    ADD CONSTRAINT stage_lookup_opt_price_fk FOREIGN KEY ( opt_price_osp_id )
        REFERENCES opt_price ( osp_id );
