...
VALUES (70010, 'Tile Upgrade', 'Standard ceramic tile for foyer', NULL, 15510, 16001); -- Price is NULL and will be automatically set.
...
-- 1) Create a session for a different stage (5)
INSERT INTO decorator_session (decoratorsession_id, "Date", stage, housetask_housetask_id, approval)
VALUES (15511, SYSDATE, 5, 44881, 'Y');
COMMIT;

-- 2) Try to insert the choice. This should fail because no price is defined for option 16001 at stage 5.
BEGIN
  INSERT INTO decorator_choice (decoratorchoice_id, item, description, price, decorator_session_id, option_option_id)
  VALUES (70011, 'Tile Upgrade Fail', 'Attempt at stage 5', NULL, 15511, 16001);
EXCEPTION
  WHEN OTHERS THEN
...
DELETE FROM decorator_choice WHERE decoratorchoice_id in (70011, 70010);
